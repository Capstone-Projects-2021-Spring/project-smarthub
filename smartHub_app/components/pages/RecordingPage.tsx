...
export default class Recording extends Component<{ route: any, navigation: any }, { profileId: number, phoneNumber: String, deviceIP: String, userEmail: String, profileName: String, checkStream: boolean}>{
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: "#222222" }}>
                ...
                <Stream type={1} deviceIP={this.state.deviceIP} deviceId={this.props.route.params.device_id} navigation={this.props.navigation} userEmail={this.state.userEmail} profileName={this.state.profileName}
